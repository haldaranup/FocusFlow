...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        toast.success('Account created successfully! Welcome to FocusFlow!')
        router.push('/dashboard')
      } else {
      ...
      <div className="relative w-full max-w-md">
        ...
        <Card className="p-8 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-gray-200 dark:border-gray-700 shadow-xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Join FocusFlow</h1>
            <p className="text-gray-600 dark:text-gray-400">Create your account and start focusing</p>
          </div>
